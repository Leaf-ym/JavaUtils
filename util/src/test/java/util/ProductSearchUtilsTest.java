...
public class ProductSearchUtilsTest {
    ...
    public void testTaoBaoSearch() throws UnsupportedEncodingException {
        ...
        String key = "杯子";
        List<ProductModel> resultList = ProductSearchUtils.getProductListBySort(key, 2, url, cookie);
        PrintUtils.println(resultList.size());
        PrintUtils.println(resultList);
        EasyExcelUtils.exportFile(resultList, "D:\\淘宝产品" + System.currentTimeMillis() + ".xlsx");
    }
