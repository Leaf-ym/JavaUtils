...
public class PcUtils {
         ...
         */
        public static String getWindowsMainBoardSerialNumber() {
            String result = "";
            try {
        ...
        public static String getMACAddress() {
            switch (getOSNamePrefix()) {
                ...
                case LINUX:
                    ...
                    if (macAddressForEth0 == null || macAddressForEth0.trim().length() == 0) {
         ...
         */
        @Data
        public static class ComputerUniqueIdentification {
