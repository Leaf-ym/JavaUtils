...
public class HttpUtils {
    ...
    public static String httpGet(String url, Map paramMap, String encodingCode) {
        System.out.println("GetPage:" + url);
        String content = null;
        ...
        String paramStr = StringUtils.removeSuffixArr(sb.toString(), "&");
        ...
        try {
            ...
            System.out.println("httpClientUtils::statusCode=" + statusCode);
            System.out.println(method.getStatusLine());
            content = new String(method.getResponseBody(), encodingCode);
        } catch (Exception e) {
            System.out.println("time out");
            e.printStackTrace();
        } finally {
    ...
    public static String httpGet(String url, Map paramMap) {
        //编码：UTF-8
        return HttpUtils.httpGet(url, paramMap, "UTF-8");
    }
    ...
    public static String httpPost(String url, Map paramMap) {
        //编码：UTF-8
        return HttpUtils.httpPost(url, paramMap, "UTF-8");
    }
    ...
    public static void main(String[] args) {
        ...
        String getUrl = "http://127.0.0.1:15506/mapi/ccbPagePayNotify";
        String backData = HttpUtils.httpGet(getUrl, paramMap);
        PrintUtils.println(backData);
    }
}
